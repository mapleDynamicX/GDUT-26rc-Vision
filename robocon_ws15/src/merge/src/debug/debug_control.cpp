...
void calibration2()
{
    ...
    Ten::XYZRPY world_origin = Ten::transform_matrixtoXYZRPY(Ten::worldtocurrent(xyzrpy._xyz, xyzrpy._rpy) * Ten::worldtocurrent(xyzrpy_error._xyz, xyzrpy_error._rpy) * Ten::_COORDINATE_TRANSFORMATION_.get_lidartocar() * Ten::_COORDINATE_TRANSFORMATION_.get_lidar_state_error());
...
void test_lidar_point_lio()
{
    ...
    while (Ten::_TREADPOOL_FLAG_.read_flag())
    {
        ...
        Ten::_COORDINATE_TRANSFORMATION_.set_worldtolidar(pose);
        Ten::XYZRPY result = Ten::_COORDINATE_TRANSFORMATION_.getXYZRPY_incline_2();
