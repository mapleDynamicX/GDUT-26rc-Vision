...
class TopicForwarder:
    def __init__(self):
        ...
        self.input_topic = rospy.get_param('~input_topic', '/scripts/check')
        self.input_topic2 = rospy.get_param('~input_topic2', '/scripts/global_check_off')
        self.input_topic3 = rospy.get_param('~input_topic3', '/scripts/send_param')
