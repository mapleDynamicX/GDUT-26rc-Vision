...
{    
    ...
    extern std::atomic<int> _usb_device_num1_;
    extern std::atomic<int> _usb_device_num2_;
    extern std::atomic<int> _usb_device_num3_;
    ...
    extern double _r1_red_0_dx_;
    extern double _r1_red_0_dy_;
    extern double _r1_red_0_dyaw_;

    extern double _r1_red_1_dx_;
    extern double _r1_red_1_dy_;
    extern double _r1_red_1_dyaw_;

    extern double _r1_red_2_dx_;
    extern double _r1_red_2_dy_;
    extern double _r1_red_2_dyaw_;

    extern double _r1_blue_0_dx_;
    extern double _r1_blue_0_dy_;
    extern double _r1_blue_0_dyaw_;

    extern double _r1_blue_1_dx_;
    extern double _r1_blue_1_dy_;
    extern double _r1_blue_1_dyaw_;

    extern double _r1_blue_2_dx_;
    extern double _r1_blue_2_dy_;
    extern double _r1_blue_2_dyaw_;

    extern double _r2_red_0_dx_;
    extern double _r2_red_0_dy_;
    extern double _r2_red_0_dyaw_;

    extern double _r2_red_1_dx_;
    extern double _r2_red_1_dy_;
    extern double _r2_red_1_dyaw_;

    extern double _r2_red_2_dx_;
    extern double _r2_red_2_dy_;
    extern double _r2_red_2_dyaw_;

    extern double _r2_blue_0_dx_;
    extern double _r2_blue_0_dy_;
    extern double _r2_blue_0_dyaw_;

    extern double _r2_blue_1_dx_;
    extern double _r2_blue_1_dy_;
    extern double _r2_blue_1_dyaw_;

    extern double _r2_blue_2_dx_;
    extern double _r2_blue_2_dy_;
    extern double _r2_blue_2_dyaw_;

    extern std::atomic<bool> _use_predicted_;
    extern std::atomic<bool> _open_point_lio_;

    extern std::atomic<bool> _is_tf_init_;
    extern std::atomic<double> _stead_tf_dx_;
    extern std::atomic<double> _stead_tf_dy_;
    ...
    namespace parameter
    {
        ...
        static void loadyamlall()
        {
            ...
            _usb_device_num1_.store(config["_usb_device_num1_"].as<int>(), std::memory_order_seq_cst);
            _usb_device_num2_.store(config["_usb_device_num2_"].as<int>(), std::memory_order_seq_cst);
            _usb_device_num3_.store(config["_usb_device_num3_"].as<int>(), std::memory_order_seq_cst);
            ...
            _r1_red_0_dx_ = config["_r1_red_0_dx_"].as<double>();
            _r1_red_0_dy_ = config["_r1_red_0_dy_"].as<double>();
            _r1_red_0_dyaw_ = config["_r1_red_0_dyaw_"].as<double>();

            _r1_red_1_dx_ = config["_r1_red_1_dx_"].as<double>();
            _r1_red_1_dy_ = config["_r1_red_1_dy_"].as<double>();
            _r1_red_1_dyaw_ = config["_r1_red_1_dyaw_"].as<double>();

            _r1_red_2_dx_ = config["_r1_red_2_dx_"].as<double>();
            _r1_red_2_dy_ = config["_r1_red_2_dy_"].as<double>();
            _r1_red_2_dyaw_ = config["_r1_red_2_dyaw_"].as<double>();

            _r1_blue_0_dx_ = config["_r1_blue_0_dx_"].as<double>();
            _r1_blue_0_dy_ = config["_r1_blue_0_dy_"].as<double>();
            _r1_blue_0_dyaw_ = config["_r1_blue_0_dyaw_"].as<double>();

            _r1_blue_1_dx_ = config["_r1_blue_1_dx_"].as<double>();
            _r1_blue_1_dy_ = config["_r1_blue_1_dy_"].as<double>();
            _r1_blue_1_dyaw_ = config["_r1_blue_1_dyaw_"].as<double>();

            _r1_blue_2_dx_ = config["_r1_blue_2_dx_"].as<double>();
            _r1_blue_2_dy_ = config["_r1_blue_2_dy_"].as<double>();
            _r1_blue_2_dyaw_ = config["_r1_blue_2_dyaw_"].as<double>();

            _r2_red_0_dx_ = config["_r2_red_0_dx_"].as<double>();
            _r2_red_0_dy_ = config["_r2_red_0_dy_"].as<double>();
            _r2_red_0_dyaw_ = config["_r2_red_0_dyaw_"].as<double>();

            _r2_red_1_dx_ = config["_r2_red_1_dx_"].as<double>();
            _r2_red_1_dy_ = config["_r2_red_1_dy_"].as<double>();
            _r2_red_1_dyaw_ = config["_r2_red_1_dyaw_"].as<double>();

            _r2_red_2_dx_ = config["_r2_red_2_dx_"].as<double>();
            _r2_red_2_dy_ = config["_r2_red_2_dy_"].as<double>();
            _r2_red_2_dyaw_ = config["_r2_red_2_dyaw_"].as<double>();

            _r2_blue_0_dx_ = config["_r2_blue_0_dx_"].as<double>();
            _r2_blue_0_dy_ = config["_r2_blue_0_dy_"].as<double>();
            _r2_blue_0_dyaw_ = config["_r2_blue_0_dyaw_"].as<double>();

            _r2_blue_1_dx_ = config["_r2_blue_1_dx_"].as<double>();
            _r2_blue_1_dy_ = config["_r2_blue_1_dy_"].as<double>();
            _r2_blue_1_dyaw_ = config["_r2_blue_1_dyaw_"].as<double>();

            _r2_blue_2_dx_ = config["_r2_blue_2_dx_"].as<double>();
            _r2_blue_2_dy_ = config["_r2_blue_2_dy_"].as<double>();
            _r2_blue_2_dyaw_ = config["_r2_blue_2_dyaw_"].as<double>();

            _use_predicted_.store(config["_use_predicted_"].as<bool>(), std::memory_order_seq_cst);
            _open_point_lio_.store(config["_open_point_lio_"].as<bool>(), std::memory_order_seq_cst);

            
            _is_tf_init_.store(false);
            _stead_tf_dx_.store(0.0);
            _stead_tf_dy_.store(0.0);
        ...
        // ========== R1 R2 红蓝目标偏移参数 ==========
        /// @brief 重新加载R1、R2红蓝靶标dx/dy/dyaw偏移参数
        static void resetTargetOffsetParam()
        {
            std::lock_guard<std::mutex> lock(parameter_mtx_);
            YAML::Node config = loadConfigFile();
