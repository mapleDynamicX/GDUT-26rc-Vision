        ...
        if(receive != last)
        {
            ...
            if(length)
            {
                ...
                else if(Ten::_input_parameter_[5] == 1)
                {
                    ...
                    if(Ten::_input_parameter_[0] == 0)
                    {
                        Ten::superstratum::_r2_xyzrpy_init_error_xyz_x_.store(_r2_red_1_dx_);
                        Ten::superstratum::_r2_xyzrpy_init_error_xyz_y_ .store(_r2_red_1_dy_);
                        Ten::superstratum::_r2_xyzrpy_init_error_rpy_yaw_ .store(_r2_red_1_dyaw_);
                    }
                    //蓝
                    else if(Ten::_input_parameter_[0] == 1)
                    {
                        Ten::superstratum::_r2_xyzrpy_init_error_xyz_x_.store(_r2_blue_1_dx_);
                        Ten::superstratum::_r2_xyzrpy_init_error_xyz_y_ .store(_r2_blue_1_dy_);
