            ...
            orb_init_cube_points()
            {
                ...
                for(size_t i = 0; i < 4; i++)
                {
                    for(size_t j = 0; j < 3; j++)
                    {
                        ...
                        Cube box;
                        box.center = Eigen::Vector3d(X_ + i*L_ + lx1_ + box_half_length_, Y_ - j*L_- ly1_ - box_half_length_ , hight_[i*3 + j] + box_half_length_);
                ...
                for(size_t i = 0; i < 4; i++)
                {
                    ...
                    {
                        Cube step;
                        step.center = Eigen::Vector3d(X_ + i*L_ + step_half_length_, Y_ - j*L_ - step_half_length_ , hight_[i*3 + j] / 2.0);
