    ...
    namespace yolo
    {
        ...
        public:
            /** 
                ...
                @param iou: 交并比
            */
            yolo_v11(const std::string model_path, const std::string xpu, float conf_thres = 0.75, float iou = 0)
            :yolo_v5(model_path, xpu, conf_thres, conf_thres, iou)
            {
