    ...
    public:
        void cameraside()
        {
            try
            {
                ...
                usbcam.reset_camera(idxs,640,480,30);
        ...
        void lidar(int flag = 1)
        {
            try
            {
                Ten::parameter::loadyaml::resetR2AllParams();
                Ten::parameter::loadyaml::resetR1AllParams();
                Ten::parameter::loadyaml::resetTargetOffsetParam();

                superstratum::_r1_xyzrpy_init_error_xyz_x_.store(0);
                superstratum::_r1_xyzrpy_init_error_xyz_y_.store(0);
                superstratum::_r1_xyzrpy_init_error_xyz_z_.store(0);
                superstratum::_r1_xyzrpy_init_error_rpy_yaw_.store(0);

                superstratum::_r2_xyzrpy_init_error_xyz_x_.store(0);
                superstratum::_r2_xyzrpy_init_error_xyz_y_.store(0);
                superstratum::_r2_xyzrpy_init_error_xyz_z_.store(0);
                superstratum::_r2_xyzrpy_init_error_rpy_yaw_.store(0);
                ...
                if(flag == 1)
                {
                    ...
                    xyzrpy_car._xyz._x = Ten::superstratum::_r1_xyzrpy_car_xyz_x_; 
                    xyzrpy_car._xyz._y = Ten::superstratum::_r1_xyzrpy_car_xyz_y_;  
                    xyzrpy_car._xyz._z = Ten::superstratum::_r1_xyzrpy_car_xyz_z_;
                    xyzrpy_car._rpy._roll = Ten::superstratum::_r1_xyzrpy_car_rpy_roll_;
                    xyzrpy_car._rpy._pitch = Ten::superstratum::_r1_xyzrpy_car_rpy_pitch_;
                    xyzrpy_car._rpy._yaw = Ten::superstratum::_r1_xyzrpy_car_rpy_yaw_;
