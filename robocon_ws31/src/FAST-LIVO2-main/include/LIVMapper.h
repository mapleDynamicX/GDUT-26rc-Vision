...
extern std::atomic<bool> _restart_lidar_;
...
public:
  ...
  // 适配FAST-LIVO2原生点云类型的发布函数
  void publishPointCloud(ros::Publisher& pub, const PointCloudXYZI::Ptr& cloud, const std::string& frame_id = "camera_init");
  void reset();
  ...
  // 修改前：int grid_size, patch_size, grid_n_width, grid_n_height, patch_pyrimid_level;
  // 修改后：
  //int grid_size = 5, patch_size = 8, grid_n_width = 23, grid_n_height = 17, patch_pyrimid_level = 3;
