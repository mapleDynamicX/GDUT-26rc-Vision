...
public:
    ...
    Ten_set_detect()
        :detector(_input_parameter_[0]==0?std::string(ROOT_DIR)+std::string("model/red/best"):std::string(ROOT_DIR)+std::string("model/blue/best"),"gpu",0.8,0.8,0.8)
    {}
