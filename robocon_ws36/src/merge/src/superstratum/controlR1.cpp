...
namespace Ten
{
    ...
    const double _vyawmax_ = 1.57;

    std::atomic<double> _r1_x_;
    std::atomic<double> _r1_y_;
    std::atomic<double> _r1_z_;
    std::atomic<double> _r1_yaw_;
        ...
        if(receive != last)
        {
            ...
            if(length)
            {
                ...
                if(Ten::_input_parameter_[5] == 0)
                {
                    ...
                    {
                        Ten::superstratum::_r1_xyzrpy_init_error_xyz_x_.store(_r1_red_0_dx_);
                        Ten::superstratum::_r1_xyzrpy_init_error_xyz_y_ .store(_r1_red_0_dy_);
                        Ten::superstratum::_r1_xyzrpy_init_error_rpy_yaw_ .store(_r1_red_0_dyaw_);
                    }
                    //蓝
                    else if(Ten::_input_parameter_[0] == 1)
                    {
                        Ten::superstratum::_r1_xyzrpy_init_error_xyz_x_.store(_r1_blue_0_dx_);
                        Ten::superstratum::_r1_xyzrpy_init_error_xyz_y_ .store(_r1_blue_0_dy_);
                        Ten::superstratum::_r1_xyzrpy_init_error_rpy_yaw_ .store(_r1_blue_0_dyaw_);
                    }
                }
                //原点
                else if(Ten::_input_parameter_[5] == 1)
                {
                    ...
                    if(Ten::_input_parameter_[0] == 0)
                    {
                        Ten::superstratum::_r1_xyzrpy_init_error_xyz_x_.store(_r1_red_1_dx_);
                        Ten::superstratum::_r1_xyzrpy_init_error_xyz_y_ .store(_r1_red_1_dy_);
                        Ten::superstratum::_r1_xyzrpy_init_error_rpy_yaw_ .store(_r1_red_1_dyaw_);
                    }
                    //蓝
                    else if(Ten::_input_parameter_[0] == 1)
                    {
                        Ten::superstratum::_r1_xyzrpy_init_error_xyz_x_.store(_r1_blue_1_dx_);
                        Ten::superstratum::_r1_xyzrpy_init_error_xyz_y_ .store(_r1_blue_1_dy_);
                        Ten::superstratum::_r1_xyzrpy_init_error_rpy_yaw_ .store(_r1_blue_1_dyaw_);
                    }
                }
                //3区
                else if(Ten::_input_parameter_[5] == 2)
                {
                    ...
                    if(Ten::_input_parameter_[0] == 0)
                    {
                        Ten::superstratum::_r1_xyzrpy_init_error_xyz_x_.store(_r1_red_2_dx_);
                        Ten::superstratum::_r1_xyzrpy_init_error_xyz_y_ .store(_r1_red_2_dy_);
                        Ten::superstratum::_r1_xyzrpy_init_error_rpy_yaw_ .store(_r1_red_2_dyaw_);
                    }
                    //蓝
                    else if(Ten::_input_parameter_[0] == 1)
                    {
                        Ten::superstratum::_r1_xyzrpy_init_error_xyz_x_.store(_r1_blue_2_dx_);
                        Ten::superstratum::_r1_xyzrpy_init_error_xyz_y_ .store(_r1_blue_2_dy_);
                        Ten::superstratum::_r1_xyzrpy_init_error_rpy_yaw_ .store(_r1_blue_2_dyaw_);
                    }
                }
    ...
    void selfinspectionR1(const std_msgs::Int32::ConstPtr& msg)
    {
        ...
        if(receive == 5 || receive == 6)
        {
            ...
            {
                lasts[2] = receives[2];
                pool.enqueue(inspectionsR1, 3);
            }
            responseR1(receive);
        }
    }

    void selfinspectioncloseR1(const std_msgs::Int32::ConstPtr& msg)
    {
        static int receives[10] = {0};
        static int lasts[10] = {0};
    ...
    void script_controlR1()
    {
        ...
        ros::Subscriber inspection_camera = nh.subscribe("/scripts/check", 3, selfinspectionR1);
        ros::Subscriber inspection_close = nh.subscribe("/scripts/global_check_off", 3, selfinspectioncloseR1);
        // 循环控频100Hz
    ...
    void tf_monitorR1(nav_msgs::Odometry msg)
    {
        ...
        else
        {
            ...
            xyzrpy_errorx._rpy._yaw = Ten::superstratum::_r1_xyzrpy_init_error_rpy_yaw_.load();
        ...
        if(Ten::_POINT_LIO_RUN_FLAG_.read_flag() && !Ten::_POINT_LIO_CHANGE_FLAG_.read_flag())
        {
            ...
            // arr[5] = result._rpy._yaw * 180.0 / M_PI;
            // serial.serial_send(arr, 1, size);
            _r1_x_.store(result._xyz._x);
            _r1_y_.store(result._xyz._y);
            _r1_z_.store(result._xyz._z);
            //Ten::superstratum::controlR1::publishOdometry(debug, msg.header.stamp);
