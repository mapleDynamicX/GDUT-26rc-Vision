...
class TouchscreenUI:
    ...
    def build_grid_block_content(self, parent):
        ...
        tk.Label(self.table_frame, text="R1\\R2", bg="#2d2d2d", fg="black", font=('DejaVu Sans', 9, 'bold'), width=7).grid(
            row=0, column=0, sticky='nsew', pady=1)
        ...
        self.court_toggle_btn = tk.Button(btn_top_frame, text="切换为蓝场", font=('DejaVu Sans', 17, 'bold'),
                                          width=30, command=self.toggle_court_side)
        self.court_toggle_btn.pack(side=tk.LEFT)
