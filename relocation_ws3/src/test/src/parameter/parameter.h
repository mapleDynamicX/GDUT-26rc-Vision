...
{    
    ...
    namespace parameter
    {
        ...
        loadyaml()
        {
            ...
            Ten::_normal_points_                                = config["_normal_points_"].as<int>();
            Ten::_fpfh_points_                                  = config["_fpfh_points_"].as<int>();
            Ten::_fpfh_match_distance_                          = config["_fpfh_match_distance_"].as<double>();
            Ten::_th1_                                          = config["_th1_"].as<double>();
            Ten::_th2_                                          = config["_th2_"].as<double>();
            Ten::_th3_                                          = config["_th3_"].as<double>();
            ...
            std::cout << "\n--- 相机内参 1920x1080 ---" << std::endl;
            std::cout << "_normal_points_:   " << Ten::_normal_points_ << std::endl;
            std::cout << "_fpfh_points_:   " << Ten::_fpfh_points_ << std::endl;
            std::cout << "_fpfh_match_distance_:   " << Ten::_fpfh_match_distance_ << std::endl;
            std::cout << "_th1_:   " << Ten::_th1_ << std::endl;
            std::cout << "_th2_:   " << Ten::_th2_ << std::endl;
            std::cout << "_th3_:   " << Ten::_th3_ << std::endl;
