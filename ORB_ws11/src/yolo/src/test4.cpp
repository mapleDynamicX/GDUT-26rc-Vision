...
// {
//     ros::init(argc, argv, "test4_node");
//     cv::Mat img = cv::imread("/home/maple/study2/maple/log2/2026_3_14/24/imageRT/imagert1/1/image.png");
//     cv::Mat rvec = (cv::Mat_<double>(3, 1) << 1.17771, -1.3717, 1.29957);
//     cv::Mat tvec = (cv::Mat_<double>(3, 1) << -1.2606, 0.517003, -1.57316);
//     cv::Mat img2 = cv::imread("/home/maple/study2/maple/log2/2026_3_14/24/imageRT/imagert1/0/image.png");
//     cv::Mat rvec2 = (cv::Mat_<double>(3, 1) << 1.08883, -1.47987, 1.40279);
//     cv::Mat tvec2 = (cv::Mat_<double>(3, 1) << -0.0804854, 0.393026, 0.488924);
//     //Ten::ORB::orb_optimize_exhaust ooe("/home/maple/study2/hou/corner2_v5s_1000_260202/best", "cpu", 0.3, 0.3, 0);
//     Ten::ORB::orb_optimize_exhaust ooe("/home/maple/study3/li/corner/best", "cpu", 0.3, 0.3, 0);
...
int main(int argc, char** argv)
{
    ...
    ros::init(argc, argv, "test4_node");
    cv::Mat img = cv::imread("/home/maple/study3/maple/2026_3_26/images/image_4.png");
    cv::Mat rvec = (cv::Mat_<double>(3, 1) << 1.22951, -1.13689, 1.11214);
    cv::Mat tvec = (cv::Mat_<double>(3, 1) << -3.72213, 1.36452, -1.52258);
    cv::Mat img2 = cv::imread("/home/maple/study3/maple/2026_3_26/images/image_8.png");
    cv::Mat rvec2 = (cv::Mat_<double>(3, 1) << 1.33632, -0.926313, 0.904401);
    cv::Mat tvec2 = (cv::Mat_<double>(3, 1) << -5.00051, 1.42991, 1.26143);
