...
void test2()
{
    //Ten::yolo::yolo_v5 detector("/home/maple/study2/hou/photo/corner_v5s_200_260116_openvino_model/corner_v5s_200_260116", "cpu", 0.2, 0.2, 0);
    Ten::yolo::yolo_v11 detector("/home/maple/study2/model/shelf_model_yolo12/best", "cpu", 0, 0);
    cv::Mat img1 = cv::imread("/home/maple/study2/hou/photo/test999_1.jpg");
    if (img1.empty()) {
...
void test3()
{
    Ten::yolo::yolo_han detector("/home/maple/study2/model/model_openvino/yolo11n_roi_16334", "cpu");
    std::vector<cv::Mat> image = loadSortedImages("/home/maple/study2/han/roi_images/roi_1");
    printHanContainer(detector.worker(image));
}
