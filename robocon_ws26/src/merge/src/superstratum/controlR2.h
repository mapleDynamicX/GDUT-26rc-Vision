    ...
    namespace superstratum
    {
        ...
        static void serial_send_lidarR2_ekf_imu()
        {
            ...
            while(Ten::_TREADPOOL_FLAG_.read_flag())
            {
                ...
                Ten::XYZRPY result = Ten::_COORDINATE_TRANSFORMATION_.getXYZRPY_incline();
                pose_and_velocity_ekf.pose = result;
                result._xyz._x += _r2_xyzrpy_init_error_xyz_x_;
                result._xyz._y += _r2_xyzrpy_init_error_xyz_y_;
                result._xyz._z += _r2_xyzrpy_init_error_xyz_z_;
                result._rpy._yaw += _r2_xyzrpy_init_error_rpy_yaw_;
        ...
        static bool calibration2()
        {
            ...
            _r2_xyzrpy_init_error_xyz_x_ = 0;
            _r2_xyzrpy_init_error_xyz_y_ = 0;
            _r2_xyzrpy_init_error_xyz_z_ = 0;
            _r2_xyzrpy_init_error_rpy_yaw_= 0;
            return true;
        }
