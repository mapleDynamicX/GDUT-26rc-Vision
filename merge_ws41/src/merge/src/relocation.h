...
public:
    ...
    */
    ...
    #define _voxeldownsample_threshold_for_teaser_ 0.6
    #define _voxeldownsample_threshold_for_icp_ 0.6
    #define _setmaxcorrespondencedistance_nano_gicp_ 0.65
...
private:
    ...
    Eigen::Matrix4d process_nano_gicp(const typename PointCloudT::Ptr& target_cloud, const typename PointCloudT::Ptr& source_cloud, float size)
    {
        ...
        nano_gicp.setMaxCorrespondenceDistance(0.55);   // 最大匹配点对距离阈值，超出距离的点对不参与配准
