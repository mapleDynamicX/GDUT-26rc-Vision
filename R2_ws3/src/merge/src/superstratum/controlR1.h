...
namespace Ten
{
    ...
    extern std::atomic<double> _r1_x_;
    extern std::atomic<double> _r1_y_;
    extern std::atomic<double> _r1_z_;
    extern std::atomic<double> _r1_yaw_;
        ...
        public:
            ...
            static void serial_send_lidarR1_ekf_imu()
            {
                ...
                while(Ten::_TREADPOOL_FLAG_.read_flag())
                {
                    ...
                    Ten::XYZRPY pose = Ten::Nav_Odometrytoxyzrpy(odo);
                    pose._rpy._yaw += _r1_xyzrpy_init_error_rpy_yaw_.load();
            ...
            static void serial_send_lidarR1_ekf_imu_withprotected()
            {
                ...
                while(Ten::_TREADPOOL_FLAG_.read_flag())
                {
                    ...
                    while(Ten::_POINT_LIO_RUN_FLAG_.read_flag() && Ten::_TREADPOOL_FLAG_.read_flag())
                    {
                        ...
                        xyzrpy_errorx._rpy._yaw = _r1_xyzrpy_init_error_rpy_yaw_.load();
