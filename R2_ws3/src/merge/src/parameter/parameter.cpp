...
namespace Ten
{
    ...
    std::atomic<int> _usb_device_num1_;
    std::atomic<int> _usb_device_num2_;
    std::atomic<int> _usb_device_num3_;
    ...
    double _r1_red_0_dx_ = 0.0;
    double _r1_red_0_dy_ = 0.0;
    double _r1_red_0_dyaw_ = 0.0;

    double _r1_red_1_dx_ = 0.0;
    double _r1_red_1_dy_ = 0.0;
    double _r1_red_1_dyaw_ = 0.0;

    double _r1_red_2_dx_ = 0.0;
    double _r1_red_2_dy_ = 0.0;
    double _r1_red_2_dyaw_ = 0.0;

    double _r1_blue_0_dx_ = 0.0;
    double _r1_blue_0_dy_ = 0.0;
    double _r1_blue_0_dyaw_ = 0.0;

    double _r1_blue_1_dx_ = 0.0;
    double _r1_blue_1_dy_ = 0.0;
    double _r1_blue_1_dyaw_ = 0.0;

    double _r1_blue_2_dx_ = 0.0;
    double _r1_blue_2_dy_ = 0.0;
    double _r1_blue_2_dyaw_ = 0.0;





    double _r2_red_0_dx_ = 0.0;
    double _r2_red_0_dy_ = 0.0;
    double _r2_red_0_dyaw_ = 0.0;

    double _r2_red_1_dx_ = 0.0;
    double _r2_red_1_dy_ = 0.0;
    double _r2_red_1_dyaw_ = 0.0;

    double _r2_red_2_dx_ = 0.0;
    double _r2_red_2_dy_ = 0.0;
    double _r2_red_2_dyaw_ = 0.0;

    double _r2_blue_0_dx_ = 0.0;
    double _r2_blue_0_dy_ = 0.0;
    double _r2_blue_0_dyaw_ = 0.0;

    double _r2_blue_1_dx_ = 0.0;
    double _r2_blue_1_dy_ = 0.0;
    double _r2_blue_1_dyaw_ = 0.0;

    double _r2_blue_2_dx_ = 0.0;
    double _r2_blue_2_dy_ = 0.0;
    double _r2_blue_2_dyaw_ = 0.0;


    std::atomic<bool> _use_predicted_;
    std::atomic<bool> _open_point_lio_;
    
    std::atomic<bool> _is_tf_init_;
    std::atomic<double> _stead_tf_dx_;
    std::atomic<double> _stead_tf_dy_;
