...
class TouchscreenUI:
    ...
    def build_left_panel(self, parent, col):
        ...
        self.btn_grid_view = tk.Button(title_bar, text="梅林输入区", font=('DejaVu Sans', 24, 'bold'),
                                       command=lambda: self.switch_left_view('grid'))
        self.btn_grid_view.pack(side=tk.LEFT, expand=True, fill=tk.X, padx=1)
        # 新增参数配置Tab按钮
        self.btn_param_view = tk.Button(title_bar, text="参数配置区", font=('DejaVu Sans', 24, 'bold'),
                                        command=lambda: self.switch_left_view('param'))
        self.btn_param_view.pack(side=tk.LEFT, expand=True, fill=tk.X, padx=1)
        self.btn_check_view = tk.Button(title_bar, text="设备自检区", font=('DejaVu Sans', 24, 'bold'),
    ...
    def build_grid_block_content(self, parent):
        ...
        self.manual_mode_btn = tk.Button(btn_top_frame, text="手动路径", bg="#44475a", fg="white",
                                         font=('DejaVu Sans', 17, 'bold'), command=self.toggle_manual_mode)
        self.manual_mode_btn.pack(side=tk.LEFT)

        # 修改：将原本宽度 30 缩小，给新按钮腾位置
        self.court_toggle_btn = tk.Button(btn_top_frame, text="切蓝场", font=('DejaVu Sans', 17, 'bold'),
                                           command=self.toggle_court_side)
        self.court_toggle_btn.pack(side=tk.LEFT, padx=2)

        # 新增：赛制切换按钮
        self.match_mode_toggle_btn = tk.Button(btn_top_frame, text="切挑战赛", font=('DejaVu Sans', 17, 'bold'),
