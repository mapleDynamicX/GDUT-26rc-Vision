...
void test_relocation()
{
    ...
    Ten::Ten_relocation<pcl::PointXYZINormal> rel("/home/maple/study2/mapping/map.pcd");
    pcl::PointCloud<pcl::PointXYZINormal>::Ptr global_cloud(new pcl::PointCloud<pcl::PointXYZINormal>);
    pcl::PointCloud<pcl::PointXYZINormal>::Ptr local_cloud(new pcl::PointCloud<pcl::PointXYZINormal>); 
    pcl::io::loadPCDFile<pcl::PointXYZINormal>(global_pcd_path, *global_cloud);
