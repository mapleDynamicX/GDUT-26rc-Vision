...
//----------------------------------------------
// 获取帧尺寸（宽高）
int frame_width = static_cast<int>(1920);
int frame_height = static_cast<int>(1080);
std::string output_path = "/home/maple/study2/optimize_ws8/src/debug/video/test2.mp4";
std::string sub_image_topic = "/pub_image_topic";
