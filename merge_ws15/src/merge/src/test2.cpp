...
void imageCallback(const nav_msgs::Odometry msg, cv::Mat& image_)
{
    ...
    Ten::_COORDINATE_TRANSFORMATION_.worldtolidar(xyzrpy);
    ...
    //     std::cout<<"x: "<<_x_ / 600.0<<" y: "<< _y_ / 600.0 <<" z: "<< _z_ / 600.0 <<std::endl;
    //     std::cout<<"roll: "<<_roll_ / 600.0 <<" pitch: "<< _pitch_ / 600.0 <<" yaw: "<< _yaw_ / 600.0 <<std::endl;
    //     std::cout<<"-----------------------------------------" << std::endl;
    //     sl.sleep();
    // }
...
int test_speed()
{
    ...
    Ten::_COORDINATE_TRANSFORMATION_.stead_state_error(xyzrpy_error);
    ...
    Ten::_COORDINATE_TRANSFORMATION_.world2toworld1(xyzrpy);
    // _dx = xyzrpy._xyz._x;
    // _dy = xyzrpy._xyz._y;
    // _dz = xyzrpy._xyz._z;
