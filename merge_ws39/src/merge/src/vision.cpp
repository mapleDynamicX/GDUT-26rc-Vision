...
void vision_test_super1()
{
    ...
    std::vector<std::vector<Ten::ORB::debug_orb_exhaust_element>> datasets = Ten::ORB::load_exhaust_dataset("/home/maple/study3/maple/place_debug/3/test");
    size_t num = 0;
    ...
    for(size_t i = 0; i < datasets.size(); i++)
    {
        ...
        if(flag)
        {
            ...
            Ten::ORB::save_loss_label_to_json("/home/maple/study3/maple/place_debug/3/error", i+1, place, loss);
        }
        else
        {
            num++;
        }
        Ten::ORB::save_loss_label_to_json("/home/maple/study3/maple/place_debug/3/result", i+1, place, loss);
    }
