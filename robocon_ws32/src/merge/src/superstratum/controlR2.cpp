...
namespace Ten
{
        ...
        if(receive != last)
        {
            ...
            if(length)
            {
                ...
                if(Ten::_input_parameter_[5] == 1)
                {
                    ...
                    {
                        Ten::superstratum::_r2_xyzrpy_init_error_xyz_x_.store(0.38);
                        Ten::superstratum::_r2_xyzrpy_init_error_xyz_y_.store(4.6);
                    }
    ...
    void script_controlR2()
    {
        ...
        ros::Subscriber inspection_camera = nh.subscribe("/scripts/check_camera_side", 3, selfinspection);
