...
void tfdebug(nav_msgs::Odometry msg)
{
    ...
    std::cout << "x: " << pose_fastlio._xyz._x << std::endl;
    std::cout << "y: " << pose_fastlio._xyz._y << std::endl;
    std::cout << "z: " << pose_fastlio._xyz._z << std::endl;
    std::cout << "roll: " << pose_fastlio._rpy._roll << std::endl;
    std::cout << "pitch: " << pose_fastlio._rpy._pitch << std::endl;
    std::cout << "yaw: " << pose_fastlio._rpy._yaw << std::endl;
    std::cout << "Ayaw: " << pose_fastlio._rpy._yaw * 180 / M_PI << std::endl;
    std::cout << "-------------pose_fastlio--------------" << std::endl; 
