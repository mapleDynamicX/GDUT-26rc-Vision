...
class MonitorStandalone:
    ...
    def build_monitor_block_content(self, parent):
        ...
        for idx, name in enumerate(valid_names):
            ...
            block.grid(row=idx // 3, column=idx % 3, sticky="ew", padx=5, pady=5)

            name_lbl = tk.Label(block, text=name, bg="#44475a", fg="white", font=("DejaVu Sans", 25, "bold"))
            name_lbl.pack(side=tk.LEFT, padx=10, pady=5)

            # 预留序号位置
            seq_lbl = tk.Label(block, text="", bg="#44475a", fg="#ffb86c", font=("DejaVu Sans", 25, "bold"))
            seq_lbl.pack(side=tk.RIGHT, padx=10, pady=5)
    ...
    def build_switch_buttons(self):
        ...
        self.btn_upper = tk.Button(
            switch_frame, text="上位机", font=("DejaVu Sans", 45, "bold"),
        ...
        self.btn_lower = tk.Button(
            switch_frame, text="下位机", font=("DejaVu Sans", 45, "bold"),
    ...
    def _create_single_lower_widget(self, parent_container, name):
        """渲染单个下位机数据块"""
        block = tk.Frame(parent_container, bg="#383838", bd=2, relief=tk.RAISED, height=280)
        ...
        data_label = tk.Label(
            ...
            font=("DejaVu Sans", 50, "bold"), justify=tk.LEFT, anchor="nw"
        )
    ...
    def _create_single_monitor_widget(self, parent_container, item):
        ...
        block = tk.Frame(parent_container, bg="#383838", bd=2, relief=tk.RAISED, height=280)
        block.pack_propagate(False)
        tk.Label(block, text=item["name"], bg="#383838", fg="white", font=("DejaVu Sans", 30, "bold")).pack(anchor="w",
                                                                                                            padx=10,
                                                                                                            pady=6)
